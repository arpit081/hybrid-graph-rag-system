...
def get_embeddings():
    """Returns embeddings matching LLM_PROVIDER ('openai' | 'ollama').

    NOTE: When using Ollama, ensure Neo4j vector index dimensionality matches
    the chosen model (e.g. 768 for nomic-embed-text vs 1536 for OpenAI).
    """
